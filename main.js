...
console.log(color('> WA NUMBER: +94722688477 ','silver'))
console.log(color('  Xeon Bot Inc. 2022','mediumseagreen'))
    ...
    DogeXeonOP.sendMessage(`94722688477@s.whatsapp.net`, `Thanks bro, your bot is working on my whatsapp number ez😂`, MessageType.extendedText)
